...
class Graph
{
	...
	void insertedge() 
	{
		...
		cin>>lastVertex;
		adjency[firstVertex][lastVertex]++;
		adjency[lastVertex][firstVertex]++;
	}
	...
	void deleteedge() 
	{
		...
		cout<<"Enter last vertex"<<endl;
		cin>>lastVertex;
		if(adjency[firstVertex][lastVertex] > 0) 
		{
			adjency[firstVertex][lastVertex]--;
			adjency[lastVertex][firstVertex]--;
		}
		...
		{
			adjency[firstVertex][lastVertex] = 0;
			adjency[lastVertex][firstVertex] = 0;
		}
	}
